...
public:
    ...
    typedef std::function<double(domain_t *, row_t *, double *, bcside)> bc_val_getter;
    ...
    static void create_bcs(Json::Value *bcroot, flowbc **boundaries, domain_t *_d);
